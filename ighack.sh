...
#####3#3#
check(){
if wget --spider https://github.com/Illegal2/moderkabakuvet.git/ighack/master/update.v3.2 2>/dev/null; then
cd $HOME/ighack/core
echo "ig" > update.txt
else
echo
...
option
check1(){
if wget --spider https://github.com/Illegal2/moderkabakuvet.git/patchupdateznh/main/ighack.v.1 2>/dev/null; then
cd $HOME/ighack/core
echo "igg" > patch.txt
else
echo
...
am start -a android.intent.action.VIEW -d https://t.me/+dQ3TyitUfjkyYzE0 > /dev/null 2>&1
banner
menu1
